...
$c_Lanimation_Integration$.prototype.drawMeStep$1__p1__Lanimation_SceneState__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(compl, canvas$1, ctx$1) {
  this.drawMe2$1__p1__Lanimation_SceneState__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(compl, canvas$1, ctx$1);
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setTimeout((function(canvas$1$1, ctx$1$1, compl$1) {
    return (function() {
      var this$1 = $m_Lanimation_Integration$();
      this$1.drawMeStep$1__p1__Lanimation_SceneState__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(compl$1.next__Lanimation_SceneState(), canvas$1$1, ctx$1$1)
    })
  })(canvas$1, ctx$1, compl), 20.0)
});
...
$c_Lanimation_Integration$.prototype.initGame__V = (function() {
  ...
  var size = (0.95 * $uD($g.Math.min(a, b)));
  canvas.height = $doubleToInt(size);
  canvas.width = $doubleToInt(size);
  ...
  var startOuter = $m_Lanimation_Animation$().startingPointCenter__Lanimation_Vec__D__Lanimation_Vec(origin, outerTriangleLen);
  var startStart = startOuter.$$plus__Lanimation_Vec__Lanimation_Vec(new $c_Lanimation_Vec().init___D__D(((((outerTriangleLen - sideLen) | 0) / 2) | 0), 0.0));
  var this$4 = $m_s_Console$();
  var this$5 = $as_Ljava_io_PrintStream(this$4.outVar$2.v$1);
  this$5.java$lang$JSConsoleBasedPrintStream$$printString__T__V((startStart + "\n"));
  this.drawMeStep$1__p1__Lanimation_SceneState__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(new $c_Lanimation_SceneState().init___I(0), canvas, ctx)
});
$c_Lanimation_Integration$.prototype.drawMe2$1__p1__Lanimation_SceneState__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(compl, canvas$1, ctx$1) {
  ...
  ctx$1.beginPath();
  var points = $m_Lanimation_Animation$().buildScene__D__D__Lanimation_SceneState__sci_List($uI(canvas$1.height), $uI(canvas$1.width), compl);
  ctx$1.moveTo($as_Lanimation_Vec(points.head__O()).x$1, $as_Lanimation_Vec(points.head__O()).y$1);
  var this$1 = points.tail__sci_List();
  var these = this$1;
...
$c_Lanimation_Animation$.prototype.frac1__Lanimation_Vec__Lanimation_Vec__I__sci_List = (function(st, end, a) {
  var len = st.length__Lanimation_Vec__D(end);
  var p1 = st.pointOnLine__Lanimation_Vec__D__Lanimation_Vec(end, (len / 3.0));
  var p2 = st.pointOnLine__Lanimation_Vec__D__Lanimation_Vec(end, ((2 * len) / 3.0));
  var angle = (3.141592653589793 * (a / 180.0));
  var triSide = ((len / 6) / $uD($g.Math.cos(angle)));
  var top = p1.pointOnLine__Lanimation_Vec__D__Lanimation_Vec(end, triSide);
  var top1 = top.rotate__Lanimation_Vec__D__Lanimation_Vec(p1, a);
  var this$3 = $m_sci_Nil$();
  var this$4 = new $c_sci_$colon$colon().init___O__sci_List(end, this$3);
  var this$5 = new $c_sci_$colon$colon().init___O__sci_List(p2, this$4);
  var this$6 = new $c_sci_$colon$colon().init___O__sci_List(top1, this$5);
  var this$7 = new $c_sci_$colon$colon().init___O__sci_List(p1, this$6);
  var list = new $c_sci_$colon$colon().init___O__sci_List(st, this$7);
  return list
});
...
$c_Lanimation_Animation$.prototype.buildScene__D__D__Lanimation_SceneState__sci_List = (function(height, width, compl) {
  var center = new $c_Lanimation_Vec().init___D__D((height / 2), (width / 2));
  var sideLen = (0.8 * height);
  var medianLen = ((sideLen / 2) / $uD($g.Math.cos(0.5235987755982988)));
  var x$16 = (center.y$1 - medianLen);
  var x$17 = center.x$1;
  var p1 = new $c_Lanimation_Vec().init___D__D(x$17, x$16).rotate__Lanimation_Vec__D__Lanimation_Vec(center, (-60.0));
  var x$18 = (center.y$1 - medianLen);
  var x$19 = center.x$1;
  var p2 = new $c_Lanimation_Vec().init___D__D(x$19, x$18).rotate__Lanimation_Vec__D__Lanimation_Vec(center, 60.0);
  var x$20 = (center.y$1 - medianLen);
  var x$21 = center.x$1;
  var p3 = new $c_Lanimation_Vec().init___D__D(x$21, x$20).rotate__Lanimation_Vec__D__Lanimation_Vec(center, 180.0);
  var this$3 = $m_sci_Nil$();
  var this$4 = new $c_sci_$colon$colon().init___O__sci_List(p1, this$3);
...
$c_Lanimation_Animation$.prototype.fracN__I__I__sci_List__sci_List = (function(iter, angle, points) {
  _fracN: while (true) {
    var this$2 = points;
    var end = (((-1) + $f_sc_LinearSeqOptimized__length__I(this$2)) | 0);
    var this$5 = new $c_sci_Range().init___I__I__I(0, end, 1);
    ...
    var f$1 = (function($this, angle$1, points$1) {
      return (function(i$2) {
        var i = $uI(i$2);
        var jsx$1 = $as_Lanimation_Vec($f_sc_LinearSeqOptimized__apply__I__O(points$1, i));
        var n = ((1 + i) | 0);
        var this$8 = $this.frac1__Lanimation_Vec__Lanimation_Vec__I__sci_List(jsx$1, $as_Lanimation_Vec($f_sc_LinearSeqOptimized__apply__I__O(points$1, n)), angle$1);
        var f = (function($this$1) {
          return (function(p$2) {
            var p = $as_Lanimation_Vec(p$2);
            return p
          })
        })($this);
    ...
    if ((bf$1 === $m_sci_List$().ReusableCBFInstance$2)) {
      if ((this$12 === $m_sci_Nil$())) {
        ...
        while ((rest$1 !== $m_sci_Nil$())) {
          ...
          $as_sc_GenTraversableOnce(f$1(arg1$3)).seq__sc_TraversableOnce().foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$2, found$1, h$2, t$2) {
            return (function(b$2) {
              if ((!found$1.elem$1)) {
          ...
          })(this$12, found, h$1, t$1)));
          var this$16 = rest$1;
          rest$1 = this$16.tail__sci_List()
        };
        var jsx$3 = ((!found.elem$1) ? $m_sci_Nil$() : $as_sci_$colon$colon(h$1.elem$1))
      }
    } else {
      $m_sci_List$();
      ...
      while ((!these$1.isEmpty__Z())) {
        ...
        var xs = $as_sc_GenTraversableOnce(f$1(arg1$4)).seq__sc_TraversableOnce();
        b$1.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(xs);
        var this$18 = these$1;
        these$1 = this$18.tail__sci_List()
      };
      var jsx$3 = b$1.toList__sci_List()
    };
    var vectors = $as_sci_List(jsx$3);
    if (((((-1) + iter) | 0) > 0)) {
      var temp$iter = (((-1) + iter) | 0);
      iter = temp$iter;
      points = vectors;
      continue _fracN
    } else {
...
$c_Lanimation_SceneState.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    return (this.frameCounter$1 === SceneState$1.frameCounter$1)
  } else {
    return false
  }
});
...
$c_Lanimation_SceneState.prototype.next__Lanimation_SceneState = (function() {
  return new $c_Lanimation_SceneState().init___I(((1 + this.frameCounter$1) | 0))
});
$c_Lanimation_SceneState.prototype.init___I = (function(frameCounter) {
...
$c_Lanimation_SceneState.prototype.angle__I = (function() {
  return ((((((this.frameCounter$1 / this.maxAngle$1) | 0) % 2) | 0) === 0) ? ((this.frameCounter$1 % this.maxAngle$1) | 0) : ((this.maxAngle$1 - ((this.frameCounter$1 % this.maxAngle$1) | 0)) | 0))
});
...
$c_Lanimation_Vec.prototype.rotate__Lanimation_Vec__D__Lanimation_Vec = (function(origin, angle) {
  var angleRad = (3.141592653589793 * (angle / 180.0));
  var x2 = ((($uD($g.Math.cos(angleRad)) * (this.x$1 - origin.x$1)) - ($uD($g.Math.sin(angleRad)) * (this.y$1 - origin.y$1))) + origin.x$1);
  var y2 = ((($uD($g.Math.sin(angleRad)) * (this.x$1 - origin.x$1)) + ($uD($g.Math.cos(angleRad)) * (this.y$1 - origin.y$1))) + origin.y$1);
  return new $c_Lanimation_Vec().init___D__D(x2, y2)
});
